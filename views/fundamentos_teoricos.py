...
MARKDOWN_FILE_PATH = "views/fundamentos_teoricos.md"  # Caminho do arquivo markdown
...
def save_markdown_file_to_github(content, commit_message="Atualizando arquivo de fundamentos teóricos"):
    g = Github(GITHUB_TOKEN)
    repo = g.get_repo(REPO_NAME)
...
# Página de fundamentos teóricos no Streamlit
